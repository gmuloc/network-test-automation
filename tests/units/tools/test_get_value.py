...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(INPUT_DICT, "missing_required", None, True, None, None, None, pytest.raises(ValueError, match=""), id="required"),
        pytest.param(INPUT_DICT, "missing_required", None, True, "custom_org_key", None, None, pytest.raises(ValueError, match=""), id="custom org_key"),
